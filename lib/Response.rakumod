...
sub response(:$peerip, :$buf, :$current-dir, :$default-html, :%webservices) is export {
  ...
  write-log :$peerip, :$method, :$path, :$get-params, :$body;

  # write access log
  write-access-log :$peerip, :$method, :$path, :$get-params;
